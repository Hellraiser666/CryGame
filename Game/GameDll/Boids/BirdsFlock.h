...
public:
	...
	bool GetAttractOutput() const
	{
		return m_bAttractOutput;
	}
	void SetAttractOutput(bool bAO)
	{
		m_bAttractOutput = bAO;
	}
	void Land();
	void TakeOff();
	...
	inline bool IsPlayerNearOrigin() const
	{
		return m_isPlayerNearOrigin;
	}
